...
const Card2 = (props) => {
  const [percentage, setPercentage] = useState(props.completed.toFixed());
  ...
  useEffect(() => {
    ...
    setPercentage(props.completed.toFixed());
    if (isActive) {
    ...
    console.log('CARD', props.category, isActive, percentage);
  });
            ...
            <View style={styles.rightContainer}>
              <ImageBackground
                ...
                <View
                  ...
                  <Text style={styles.xpText}>{percentage}%</Text>
                </View>
              </ImageBackground>
            </View>
          </View>
